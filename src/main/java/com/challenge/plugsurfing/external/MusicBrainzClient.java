...
public class MusicBrainzClient {
	...
	public MusicBrainzClient(@Value("${music-service.client.music-brainz.base-url}") final String baseUrl,
			final RestTemplate restTemplate, final MusicBrainzClientErrorHandler errorHandler) {
	...
	public MusicBrainzArtistResponse getArtistInformationByMBID(String mbid) {
		...
		ResponseEntity<MusicBrainzArtistResponse> musicBrainzArtistResponse = restTemplate.getForEntity(musicBrainzArtistUrl, MusicBrainzArtistResponse.class);
